...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Preguntas.orden'
        db.delete_column('encuestas_preguntas', 'orden')

        # Deleting field 'Respuestas.votes'
        db.delete_column('encuestas_respuestas', 'votes')


    def backwards(self, orm):
        # Adding field 'Preguntas.orden'
        db.add_column('encuestas_preguntas', 'orden',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Respuestas.votes'
        db.add_column('encuestas_respuestas', 'votes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
