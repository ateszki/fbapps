...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encuestas.usuario'
        db.add_column('encuestas_encuestas', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encuestas.usuario'
        db.delete_column('encuestas_encuestas', 'usuario_id')
