...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preguntas._order'
        db.add_column('encuestas_preguntas', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Respuestas._order'
        db.add_column('encuestas_respuestas', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preguntas._order'
        db.delete_column('encuestas_preguntas', '_order')

        # Deleting field 'Respuestas._order'
        db.delete_column('encuestas_respuestas', '_order')
    ...
    models = {
        ...
        'encuestas.preguntas': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Preguntas'},
        ...
        'encuestas.respuestas': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Respuestas'},
            '_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
